...
echo_and_run cd "/home/lars/realsense_ws/src/vision_opencv/image_geometry"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/lars/realsense_ws/src/vision_opencv/image_geometry/setup.py" \
     \
    build --build-base "/home/lars/realsense_ws/build/vision_opencv/image_geometry" \
    install \
    --root="${DESTDIR-/}" \

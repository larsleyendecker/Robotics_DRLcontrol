...
echo_and_run cd "/home/lars/realsense_ws/src/geometry2/tf2_ros"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/lars/realsense_ws/src/geometry2/tf2_ros/setup.py" \
     \
    build --build-base "/home/lars/realsense_ws/build/geometry2/tf2_ros" \
    install \
    --root="${DESTDIR-/}" \

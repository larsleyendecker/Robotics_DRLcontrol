...
echo_and_run cd "/home/lars/realsense_ws/src/fmauch_universal_robot/ur_driver"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/lars/realsense_ws/src/fmauch_universal_robot/ur_driver/setup.py" \
     \
    build --build-base "/home/lars/realsense_ws/build/fmauch_universal_robot/ur_driver" \
    install \
    --root="${DESTDIR-/}" \
